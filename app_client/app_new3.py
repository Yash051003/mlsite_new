...
async def process_and_send_landmarks():
    ...
    async with websockets.connect(uri) as websocket:
        ...
        while True:
            ...
            # Mirror display for consistency
            ...
            if results.multi_hand_landmarks:
                for hand_landmarks, handedness in zip(results.multi_hand_landmarks, results.multi_handedness):
                    ...
                    hand_results.append({
                        ...
                        "landmarks": pre_processed_landmark_list
                    })
            
            # Send results to Django backend
            if hand_results:
                await websocket.send(json.dumps({
                    "hand_data": hand_results
                }))
            ...
            # Optional: send a frame for visualization
...
if __name__ == '__main__':
    asyncio.run(process_and_send_landmarks())
